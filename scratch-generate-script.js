...
const gw3SquadEntries = gw3Squad.map(s => {
...
const TEAMS = [
  ...
  { id: 10, name: 'Hull City', short: 'HUL' },
  { id: 11, name: 'Ipswich Town', short: 'IPS' },
  { id: 12, name: 'Leeds United', short: 'LEE' },
  { id: 13, name: 'Liverpool', short: 'LIV' },
  { id: 14, name: 'Manchester City', short: 'MCI' },
  { id: 15, name: 'Manchester Utd', short: 'MUN' },
  { id: 16, name: 'Newcastle', short: 'NEW' },
  { id: 17, name: 'Nottingham Forest', short: 'NFO' },
  { id: 18, name: 'Tottenham', short: 'TOT' },
  { id: 19, name: 'West Ham', short: 'WHU' },
  { id: 20, name: 'Wolves', short: 'WOL' }
];
...
const state = {
  ...
  myTeamPosFilter: 'all',
  scoutingFilter: { pos: 'all', search: '', maxPrice: 16.0 },
    ...
    if (isGw3) {
      explainBox.innerHTML = \`
        <p class="panel-desc" style="line-height: 1.6; font-size: 13px; color: #cbd5e1;">
          The updated GW3 model applies <strong>60% Pre-Season Prior</strong> + <strong>40% Observed 2026/27 Performance</strong> across Gameweeks 1 & 2.
        </p>
      ...
      <div class="picker-player-row">
        <div class="picker-player-info">
          ...
          <div>
            ...
            <span style="font-size:11px; color:#94a3b8; display:block;">\${p.team} • \${p.selected_by}% Owned</span>
          </div>
        </div>

        <div class="picker-player-stats">
          <span style="color:#94a3b8;">£\${p.cost.toFixed(1)}m</span>
...
console.log('Successfully wrote prototype/script.js');
